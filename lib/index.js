 ...
 * input configuration
 * @param {NotebookConfig} userConfig Input configuration
 ...
 * @param {NotebookConfig} userConfig Input configuration
 * @param {NotebookData} notebookData Notebook data object
...
function data2notebook(userConfig, notebookData) {
  ...
  switch(userConfig.type) {
    case "cap":
      notebook = data2cap(notebookData, userConfig.styles);
      break;
    case "jupyter":
      notebook = data2jupyter(notebookData, userConfig.styles);
      break;
  }
